            ...
            <div className="keranjang d-flex">
                <div className="cart" style={{ maxHeight: '100vh', overflowY: 'auto' }}>
                    <section>
                        ...
                        <CartNavbar activeButtonType={activeButtonType}
                            handleButtonClick={handleButtonClick} />
                        {(packingVisible || antarVisible || selesaiVisible) ? (
                                ...
                                <div className="sum">
                                    ...
                                    {detailData && detailData.map((item) => (
                                        <span style={{ textAlign: "right" }}>
                                            ...
                                            <p>Tunai</p>
                                            <p>{item.jumlah}</p>
                                            <p><b>{item.harga_total}</b></p>
                                        </span>
                                    ))}
                                </div>
                            </div>
                        ) : <h1 style={{margin: 'auto'}}>Tidak ada pesanan</h1> }
                    </section>
                    {(selesaiVisible) && (
